...
class View
{
  ...
  //Display the Forum
  public function include_forum($topics, $number_of_pages, $page_number){
  ...
  public function yourFavoritesScreen($topics, $number_of_pages, $page_number){
    include_once 'forum.php';
    $forum = new Forum();
    $forum->addTopics($topics);
    $forum->addNumberOfPages($number_of_pages);
  ...
  public function researchForumScreen($topics, $number_of_pages, $page_number, $research_content){
    include_once 'forum.php';
    $forum = new Forum();
    $forum->addTopics($topics);
    $forum->addNumberOfPages($number_of_pages);
  ...
  public function researchYourFavoritesScreen($topics, $number_of_pages, $page_number, $research_content){
    include_once 'forum.php';
    $forum = new Forum();
    $forum->addTopics($topics);
    $forum->addNumberOfPages($number_of_pages);
  ...
  public function include_sujet($topic, $messages, $number_of_pages, $page_number){
    include_once 'sujet.php';
    $sujet = new Sujet();
    $sujet->addTopic($topic);
