                  ...
                  echo '<tr>';
                    ...
                    echo '<td class="d-flex justify-content-around">';
                      if($topic['is_favorite'] == false){
                        ...
                        echo '<button name="" type="submit" class="btn btn-secondary" value="">Supprimer</button>';
                      }
                      else{
                        echo '<button name="" type="submit" class="btn btn-secondary" value="">Supprimer</button>';
                      }
              ...
              echo '<tbody>';
                while($topic = $this->topics->fetch()){
                  echo '<tr>';
                    ...
                    echo '<td class="align-middle">'.$topic['date_heure'].'</td>';
                    echo '<td class="d-flex justify-content-around">';
                      echo '<button name="" type="submit" class="btn btn-secondary" value="">Signaler</button>';
                      echo '<button name="" type="submit" class="btn btn-secondary" value="">Supprimer</button>';
                    echo '</td>';
                  echo '</tr>';
                }
