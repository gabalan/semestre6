		...
		actions = new Action[] {
			...
			new Action() {	// [3] AE = AE.x PLUS AE.y
				public Symbol reduce(Symbol[] _symbols, int offset) {
					...
					ArithEX arith=new ArithEX(x.getArithEX() + y.getArithEX());System.out.print(" "+arith.arithValue+" ");return arith;
				}
			},
			new Action() {	// [4] AE = AE.x MINUS AE.y
				public Symbol reduce(Symbol[] _symbols, int offset) {
					...
					final Symbol _symbol_y = _symbols[offset + 3];
					final ArithEX y = (ArithEX) _symbol_y.value;
					ArithEX arith =new ArithEX(x.getArithEX() - y.getArithEX()) ;System.out.print(" "+arith.arithValue+"r ");return arith;
				}
			},
			new Action() {	// [5] AE = MINUS AE.x
				public Symbol reduce(Symbol[] _symbols, int offset) {
					...
					final ArithEX x = (ArithEX) _symbol_x.value;
					ArithEX arith = new ArithEX(-x.getArithEX());				System.out.print(" "+arith.arithValue+" ");return arith;
				}
			},
			...
			new Action() {	// [9] AE = NUMBER.x
				public Symbol reduce(Symbol[] _symbols, int offset) {
					...
					ArithEX arith= new ArithEX(x.doubleValue());		System.out.print(" "+arith.arithValue+" ");return arith;
				}
			},
			new Action() {	// [10] LE = LE.x AND LE.y
				public Symbol reduce(Symbol[] _symbols, int offset) {
					...
					final Symbol _symbol_y = _symbols[offset + 3];
					final ArithEX y = (ArithEX) _symbol_y.value;
					ArithEX arith= new ArithEX(x.getLogicVa() && y.getLogicVa());System.out.print(" "+arith.logicValue+" ");return arith;
				}
			},
			...
			new Action() {	// [12] LE = NOT LE.x
				public Symbol reduce(Symbol[] _symbols, int offset) {
					final Symbol _symbol_x = _symbols[offset + 2];
					final ArithEX x = (ArithEX) _symbol_x.value;
					ArithEX arith=new ArithEX( ! x.getLogicVa() );System.out.print(" "+arith.logicValue+" ");return arith;
				}
			},
			...
			new Action() {	// [14] LE = TRUE.x
				public Symbol reduce(Symbol[] _symbols, int offset) {
					...
					ArithEX arith=new ArithEX(x.booleanValue());	System.out.print(" "+arith.logicValue+" ");return arith;
				}
			},
			...
			new Action() {	// [16] CE = AE.x LT AE.y
				public Symbol reduce(Symbol[] _symbols, int offset) {
					...
					final Symbol _symbol_y = _symbols[offset + 3];
					final ArithEX y = (ArithEX) _symbol_y.value;
					ArithEX arith= new ArithEX(x.getArithEX() < y.getArithEX());	System.out.print(" "+arith.logicValue+" ");return arith;
				}
			},
